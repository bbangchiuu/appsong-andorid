...
public class BannerAdapter extends PagerAdapter {
    Context context;
    ArrayList<Quangcao> arrayList = new ArrayList<Quangcao>();
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        Picasso.with(context).load(arrayList.get(position).getHinhanh()).into(imgbackgroundbanner);
        Picasso.with(context).load(arrayList.get(position).getHinhBaiHat()).into(imgsongbanner);
